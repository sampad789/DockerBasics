...
```bash
git clone https://github.com/sampad789/DockerBasics.git
cd your-project
```
...
For a few specific applications, we require environment variables. I've included a sample .env.example file for this project . 
